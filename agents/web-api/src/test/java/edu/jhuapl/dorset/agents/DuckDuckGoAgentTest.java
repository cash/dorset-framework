...
public class DuckDuckGoAgentTest {
    ...
    public void testGetGoodResponse() {
        ...
        assertEquals(AgentStatusCode.SUCCESS, response.getStatusCode());
    ...
    public void testGetDisambiguationResponse() {
        ...
        assertEquals(AgentStatusCode.MORE_INFORMATION_NEEDED, response.getStatusCode());
    }
    ...
    public void testGetEmptyResponse() {
        ...
        assertEquals(AgentStatusCode.UNKNOWN_ANSWER, response.getStatusCode());
    }
